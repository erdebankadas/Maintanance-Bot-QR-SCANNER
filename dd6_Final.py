...
class QRCodeGeneratorApp:
    ...
    def process_data(self):
        ...
        try:
            ...
            # ================= ALL AT A GLANCE =================
            # All active machines EXCEPT DEPT 06
            # DEPT 06 : Active='N' with CLD_McNo filters
            ...
            # ================= ONLY MILL SIDE =================
            # Mill depts: 02,03,04,05 use Active='Y'
            # DEPT 06 (WINDING) also mill side: Active='N' with filters
            ...
            # ================= ONLY FACTORY SIDE =================
            # DEPT 06 is mill side so excluded here entirely
            ...
            # ================= ANY PARTICULAR MACHINE =================
            # Handles both normal depts (Active='Y') and
            # DEPT 06 machines (Active='N') in a single query
